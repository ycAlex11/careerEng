...
- When the user asks to summarize or persist recent Codex messages, preserve the requested window size with `python -m careereng assistant import-candidates <file> --source-limit <N> --source-thread <thread_id> --source-client codex`.
